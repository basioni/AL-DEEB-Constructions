...
function of_load_only() {
	...
	wp_enqueue_script( 'jquery-input-mask', ADMIN_DIR .'assets/js/jquery.maskedinput-1.2.2.js', array(), '', true );
	
	wp_enqueue_script( 'swfobject2', ADMIN_DIR . 'assets/js/opensave.js',  array(), '', true );
	// Enqueue jquery isotope
	wp_enqueue_script( 'isotope', CONTRACTOR_TEMPLATE_URL . '/assets/js/vendor/isotope.pkgd.min.js', array(), '', true );
	wp_enqueue_script( 'jquery-ace-contractor', ADMIN_DIR . 'assets/js/editor/vendor/ace.js', array('jquery'), '', false );

	wp_enqueue_script( 'tipsy', ADMIN_DIR .'assets/js/jquery.tipsy.js', array(), '', true );
	wp_enqueue_script( 'cookie', ADMIN_DIR . 'assets/js/cookie.js', array(), '', true );
	wp_enqueue_script( 'smof', ADMIN_DIR .'assets/js/smof.js', array(), '', true );
